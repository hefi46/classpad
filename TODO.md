...
- [ ] **Manual "refresh config now" icon** (bottom-left or bottom-right of screen) — lets a teacher force an immediate `/config` poll instead of waiting for Phase 9's interval, useful for troubleshooting ("did the new plugin show up yet") without a reboot.
